...
export default defineConfig(() => {
    ...
    return {
        ...
        preview: {
            allowedHosts: ["tahours.space", "d000-137-146-130-98.ngrok-free.app", "da5d-137-146-130-98.ngrok-free.app", "42a4-137-146-130-98.ngrok-free.app", "localhost"], // Add ngrok host here
        },
        // preview: {
